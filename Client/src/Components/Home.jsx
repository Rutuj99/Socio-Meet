    ...
    <div className="Home-Main1">
      ...
      <div className="Home-Main2">
        ...
        <div className="Home-Ad">
          ...
          <h6>
            Everyday comfort gets a modern look. The E-Series AD was designed
            with ease of entry in mind, which will have you reaching for them
            day after day.
          </h6>
          <AutoplaySlider />
        </div>
